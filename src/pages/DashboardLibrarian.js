...
export default function DashboardLibrarian() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {/* Overdue Books */}
      <h2 className="text-2xl font-semibold mb-4 text-red-600">Overdue Books</h2>
      {overdue.length > 0 ? (
              ...
              {overdue.map((o) => {
                ...
                return (
                  <tr key={o._id} className="text-center">
                   <td className="px-4 py-2 border">{o.book?.title || "Untitled"}</td>
<td className="px-4 py-2 border">{o.student?.name || "Unknown"}</td>
